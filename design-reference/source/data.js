/* Sample roster — fictional content, no copyrighted text */
      ...
      weapons: [
        {
          ...
          mods: [
            { label: '+1 to Hit', cond: 'if remained stationary' },
          ],
        },
        {
        ...
        },
        {
          ...
          mods: [
            { label: 'Lethal Hits', cond: 'vs Vehicle' },
          ],
        },
      ],
      abilities: [
